...
@Entity
public class OtherBankOnHoldRecord implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OtherBankOnHoldRecord)) {
            return false;
        }
        OtherBankOnHoldRecord other = (OtherBankOnHoldRecord) object;
    ...
    public String toString() {
        return "ejb.otherbanks.entity.OnHoldRecordId[ id=" + onHoldRecordId + " ]";
    }
